...
- [002-architecture.md](./v2/002-architecture.md) — Domain types (`WorkItem`, `WorkItemChanged`
  event), poller mechanism.
...
- [002-architecture.md: Domain Events](./v2/002-architecture.md#domain-events) — `WorkItemChanged`
  event definition.
